 ...
 * @param php\src\OAuth2\Request $request
 * @param php\src\OAuth2\Response $response
 */
function hook_oauth2_server_token($server, php\src\OAuth2\Request $request, php\src\OAuth2\Response $response)
{
 ...
 *
 * Invoked by OAuth2_Scope_Backdrop.
